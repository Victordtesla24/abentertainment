      ...
      <div className="container-eu max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section className="border-l-4 border-[#CC8A1C] pl-6">
            ...
            <p className="text-[#FDF8F1] font-body leading-relaxed mb-3">
            ...
            <p className="text-[#FDF8F1] font-body leading-relaxed">
          ...
          <section className="border-l-4 border-[#CC8A1C] pl-6">
            ...
            <address className="not-italic text-[#FDF8F1] font-body mt-4 leading-relaxed">
