...
export default function PrivacyPage() {
  return (
    <section className="min-h-screen bg-[#0A0A0A] pt-28 pb-16 sm:pt-32 sm:pb-24">
      <div className="container-eu max-w-4xl">
        <h1 className="text-4xl sm:text-5xl font-display font-bold text-[#C9A84C] mb-4">
          Privacy Policy
        </h1>
        <p className="text-white/40 text-sm font-body mb-12">
          Last updated: 28 March 2026
        </p>

        <div className="prose prose-invert max-w-none space-y-8">
          <section className="border-l-4 border-[#C9A84C] pl-6">
            <h2 className="text-2xl font-display text-[#C9A84C] mb-4">1. Information We Collect</h2>
          ...
          <section className="border-l-4 border-[#C9A84C] pl-6">
            <h2 className="text-2xl font-display text-[#C9A84C] mb-4">2. How We Use Your Information</h2>
            <p className="text-white font-body leading-relaxed mb-3">
          ...
          <section className="border-l-4 border-[#C9A84C] pl-6">
            <h2 className="text-2xl font-display text-[#C9A84C] mb-4">3. Australian Privacy Principles</h2>
            <p className="text-white font-body leading-relaxed mb-3">
          ...
          <section className="border-l-4 border-[#C9A84C] pl-6">
            <h2 className="text-2xl font-display text-[#C9A84C] mb-4">4. Data Storage and Security</h2>
            <p className="text-white font-body leading-relaxed">
          ...
          <section className="border-l-4 border-[#C9A84C] pl-6">
            <h2 className="text-2xl font-display text-[#C9A84C] mb-4">5. Your Rights</h2>
            <p className="text-white font-body leading-relaxed mb-3">
            ...
            <p className="text-white font-body leading-relaxed">
              ...
              <a href={`mailto:${SITE_CONFIG.contact.email}`} className="text-[#C9A84C] hover:underline">
          ...
          <section className="border-l-4 border-[#C9A84C] pl-6">
            <h2 className="text-2xl font-display text-[#C9A84C] mb-4">6. Cookies and Tracking</h2>
            <p className="text-white font-body leading-relaxed">
          ...
          <section className="border-l-4 border-[#C9A84C] pl-6">
            <h2 className="text-2xl font-display text-[#C9A84C] mb-4">7. Contact Us</h2>
            <p className="text-white font-body leading-relaxed">
            ...
            <address className="not-italic text-white font-body mt-4 leading-relaxed">
              <strong className="text-[#C9A84C]">{SITE_CONFIG.name}</strong>
              <br />
              Email:{' '}
              <a href={`mailto:${SITE_CONFIG.contact.email}`} className="text-[#C9A84C] hover:underline">
                {SITE_CONFIG.contact.email}
