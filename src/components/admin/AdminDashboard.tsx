...
type Tab = 'health' | 'events' | 'sponsors' | 'gallery' | 'heroes' | 'videos' | 'timeline' | 'testimonials' | 'settings' | 'ai' | 'agents' | 'conversations';
...
const TABS: { id: Tab; label: string; desc: string }[] = [
  ...
  { id: 'agents', label: 'Agent Config', desc: 'Model & prompt management' },
    ...
    <div className="flex min-h-screen bg-[#060606]">
      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="p-8">
          ...
          {activeTab === 'agents' && <AgentManager initialAgents={initialAgents} />}
