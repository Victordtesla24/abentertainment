...
const SITE_IMAGES: { category: string; label: string; images: { src: string; alt: string }[] }[] = [
  {
    ...
    images: [
      { src: '/images/hero-stage.jpg', alt: 'Homepage Hero Background 1 — Golden Stage' },
      { src: '/images/hero-performance.jpg', alt: 'Homepage Hero Background 2 — Classical Performance' },
      { src: '/images/hero-audience.jpg', alt: 'Homepage Hero Background 3 — Concert Audience' },
      ...
      { src: '/images/heroes/community-hero.png', alt: 'Community Page Hero' },
