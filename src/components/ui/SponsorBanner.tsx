      ...
      <div className="relative overflow-hidden group">
        ...
        <div className="flex items-center gap-10 px-4 py-3 animate-scroll-left w-max group-hover:[animation-play-state:paused]">
          {marqueeItems.map((sponsor, i) => (
            ...
            >
              <div className="w-10 h-10 flex items-center justify-center grayscale sepia brightness-[0.85] hue-rotate-[10deg] opacity-40 group-hover/item:grayscale-0 group-hover/item:sepia-0 group-hover/item:brightness-100 group-hover/item:hue-rotate-0 group-hover/item:opacity-100 transition-all duration-500">
