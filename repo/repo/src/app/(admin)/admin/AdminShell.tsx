        ...
        <div className="flex h-full flex-col">
          <div className="border-b border-white/8 px-6 py-5">
            <Link href="/" className="flex items-center gap-3">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl border border-[#c9a84c]/30 bg-[#c9a84c]/10 font-serif text-sm font-semibold text-[#c9a84c]">
                AB
              </span>
              <div>
                <p className="text-sm font-semibold text-white">AB Entertainment</p>
