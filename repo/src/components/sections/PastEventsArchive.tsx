      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[0.76fr_1.24fr] lg:items-start">
          ...
          >
            ...
            <p className="mt-6 font-body text-base leading-relaxed text-ivory/75 md:text-lg">
                ...
                <Link href={event.href} aria-label={`View ${event.title} gallery`}>
                  ...
                  <div className="relative h-72 w-full overflow-hidden">
                    <Image
                      ...
                      quality={85}
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-charcoal-deep/95 via-charcoal/40 to-transparent transition-opacity duration-500 group-hover:via-charcoal/30" />
                  </div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5">
                    ...
                    <p className="mt-2 font-body text-sm leading-relaxed text-ivory/75 opacity-0 transition-all duration-400 group-hover:opacity-100">
                      {event.note}
                    </p>
                  </div>
                </Link>
