          ...
          >
            ...
            <div className="flex items-center gap-3 border-b border-gold/12 px-5 py-4">
              ...
              <div>
                ...
                <p className="font-body text-[0.6rem] uppercase tracking-[0.24em] text-ivory/40">
            ...
            >
              <div className="flex items-center gap-2">
                <input
                  ref={inputRef}
                  className="flex-1 rounded-full border border-ivory/10 bg-charcoal-light/50 px-4 py-2.5 font-body text-sm text-ivory placeholder-ivory/30 outline-none transition-colors focus:border-gold/40 focus:ring-0"
                  value={input}
