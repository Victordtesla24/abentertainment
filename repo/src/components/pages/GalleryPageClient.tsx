          ...
          >
            ...
            <div className="absolute inset-x-0 bottom-0 p-6">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span className="rounded-full border border-ivory/10 bg-ivory/5 px-3 py-1 font-body text-[0.58rem] uppercase tracking-[0.28em] text-ivory/72">
              ...
              <p className="mt-3 max-w-lg font-body text-sm leading-relaxed text-ivory/78">
                {item.alt}
              </p>
              <p className="mt-4 font-body text-xs uppercase tracking-[0.2em] text-ivory/65">
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-8 md:p-12">
                ...
                <p className="mt-6 font-body text-sm uppercase tracking-[0.25em] text-ivory/72">
