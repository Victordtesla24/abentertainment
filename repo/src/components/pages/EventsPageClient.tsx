          ...
          >
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              <div className="rounded-[1.3rem] border border-ivory/10 bg-ivory/5 p-4">
                <p className="font-body text-[0.58rem] uppercase tracking-[0.28em] text-ivory/60">
                  Upcoming
                </p>
              ...
              >
                ...
                <div className="relative grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
                  <div>
                    ...
                    <p className="mt-5 font-body text-base leading-relaxed text-ivory/78 md:text-lg">
                      {leadEvent.description}
                    </p>
                    <div className="mt-8 space-y-3 font-body text-sm text-ivory/72">
              ...
              {remainingEvents.map((event, index) => (
                ...
                >
                  ...
                  <div className="mt-6 flex items-center justify-between gap-4">
                    <span className="font-body text-sm text-ivory/65">
                      {event.venue.name}
                    </span>
                    <Link
