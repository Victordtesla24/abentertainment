      ...
      <article className="min-h-screen bg-charcoal-deep">
        ...
        <div className="mx-auto max-w-5xl px-6 py-16">
          ...
          >
                    ...
                    {event.artists.map((artist) => (
                      ...
                      >
                        ...
                        <div>
                          <p>{artist.name}</p>
                          {artist.role ? (
                            <p className="font-body text-xs uppercase tracking-[0.2em] text-ivory/35">
                              {artist.role}
                            </p>
                          ) : null}
                        </div>
            ...
            >
              <div>
                <h3 className="font-body text-xs font-medium uppercase tracking-widest text-ivory/40">
                  Date & Time
                </h3>
                <time
                  dateTime={event.date}
