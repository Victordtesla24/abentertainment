...
export function ContactForm() {
  ...
  const inputClassName =
    "w-full rounded-2xl border border-ivory/10 bg-charcoal px-5 py-4 font-body text-sm text-ivory placeholder:text-ivory/30 transition-colors duration-300 focus:border-gold/40 focus:outline-none focus:ring-1 focus:ring-gold/30";
