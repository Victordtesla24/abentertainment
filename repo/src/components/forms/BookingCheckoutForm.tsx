...
export function BookingCheckoutForm({
  ...
  const fieldClassName =
    "w-full rounded-2xl border border-ivory/10 bg-charcoal px-4 py-3 font-body text-sm text-ivory placeholder:text-ivory/45 transition-colors duration-300 focus:border-gold/40 focus:outline-none focus:ring-1 focus:ring-gold/30";
  ...
  return (
    <form action={formAction} className="space-y-4 rounded-2xl border border-gold/15 bg-charcoal-deep/70 p-5">
      ...
      <div>
        <label htmlFor={`booking-name-${eventSlug}`} className="mb-2 block font-body text-xs uppercase tracking-[0.2em] text-ivory/65">
          Full name
        </label>
        <input
      ...
      <div>
        <label htmlFor={`booking-email-${eventSlug}`} className="mb-2 block font-body text-xs uppercase tracking-[0.2em] text-ivory/65">
          Email
        </label>
        <input
      ...
      <div>
        <label htmlFor={`booking-quantity-${eventSlug}`} className="mb-2 block font-body text-xs uppercase tracking-[0.2em] text-ivory/65">
          Quantity
        </label>
        <select
