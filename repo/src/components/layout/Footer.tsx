    ...
    <footer className="border-t border-border bg-charcoal-deep text-ivory/70">
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2" id="footer">
            ...
            <p className="mt-5 max-w-md font-body text-sm leading-relaxed text-ivory/72">
            ...
            <div className="mt-6 flex gap-4">
              {Object.entries(SITE_CONFIG.social).map(([platform, url]) => (
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-ivory/10 text-ivory/65 transition-all duration-300 hover:border-gold/40 hover:text-gold"
      ...
      <div className="border-t border-ivory/5">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-6 py-6 md:flex-row lg:px-8">
          <p className="font-body text-xs text-ivory/55">
            &copy; {currentYear} {SITE_CONFIG.name}. All rights reserved.
          </p>
          <div className="flex gap-6">
            <Link
              href="/privacy"
              className="font-body text-xs text-ivory/55 transition-colors hover:text-ivory/85"
            >
              Privacy Policy
            </Link>
            <Link
