    ...
    image: ({ value }: any) => {
      ...
      return (
        <figure className="my-10">
          ...
          {value.caption && (
            <figcaption className="mt-3 text-center font-body text-xs text-ivory/65">
              {value.caption}
            </figcaption>
          )}
        </figure>
        ...
        <div className="container mx-auto px-4 max-w-3xl pt-12 pb-24">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-6">
            ...
            {post.tags?.map((tag: string) => (
              <span
                key={tag}
                className="font-mono text-[10px] tracking-[0.2em] uppercase text-ivory/55 border border-ivory/10 rounded-full px-3 py-1"
              >
                {tag}
              </span>
            ))}
          ...
          {/* Excerpt */}
          {post.excerpt && (
            <p className="font-body text-xl text-ivory/72 italic leading-relaxed mb-8 border-l-2 border-gold/30 pl-5">
              {post.excerpt}
            </p>
          )}
          ...
          <div className="flex items-center gap-4 mb-12 pb-12 border-b border-ivory/10">
            <div>
              ...
              <p className="font-mono text-xs text-ivory/65">
                {post.publishedAt
              ...
              >
                ...
                <div>
                  ...
                  {post.relatedEvent.date && (
                    <p className="font-mono text-xs text-ivory/65 mt-1">
